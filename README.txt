...
Tags: hotel booking engine, hotel booking system, hotel, booking, hotel booking
...
4. Add the credentials provided by Bookwize Support (API Key, Hotel ID, Hotel Url).
5. Create a new page and select Bookwize Integrated for Page Type, give a title and save the page.
6. To set a My Reservation Page you have to create a new page and add the shortcode [bw_myreservation].
7. In order to set a currency selector you have to add the shortcode [bw_currency].
...
== Screenshot ==
1. Booking First Step
2. Booking Second Step
3. Booking Third Step